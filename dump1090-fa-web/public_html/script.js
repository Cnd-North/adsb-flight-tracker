...
function processReceiverUpdate(data, receiver_source) {
        ...
        for (var j=0; j < acs.length; j++) {
                ...
                if (Planes[hex]) {
                        ...
                        // If all planes are selected, select this new plane too
...
function initialize() {
        ...
        // Also check for the enhanced 5-point gradient (0/0, 5000/30, 15000/120, 30000/200, 40000/280)
        if (ColorByAlt.air.h.length === 5 && ColorByAlt.air.h[0].alt === 0 && ColorByAlt.air.h[0].val === 0 && ColorByAlt.air.h[1].alt === 5000 && ColorByAlt.air.h[1].val === 30 && ColorByAlt.air.h[2].alt === 15000 && ColorByAlt.air.h[2].val === 120 && ColorByAlt.air.h[3].alt === 30000 && ColorByAlt.air.h[3].val === 200 && ColorByAlt.air.h[4].alt === 40000 && ColorByAlt.air.h[4].val === 280) {
            customAltitudeColors = false;
        }
...
function end_load_history() {
        ...
        // Show all aircraft tracks by default
        selectAllPlanes();
}
