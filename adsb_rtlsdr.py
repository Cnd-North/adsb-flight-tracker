...
class adsb_rtlsdr(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "ADS-B Receiver (RTL-SDR)", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("ADS-B Receiver (RTL-SDR)")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "adsb_rtlsdr")
...
def main(top_block_cls=adsb_rtlsdr, options=None):
